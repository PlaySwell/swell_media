module SwellMedia
	class ArticleAdminController < ApplicationController
		...
		private
			def article_params
				params.require( :article ).permit( :title, :subtitle, :slug_pref, :description, :content, :category_id, :status, :publish_at, :show_title, :is_commentable, :user_id, :tags, :avatar, :avatar_asset_file, :avatar_asset_url )
			end
