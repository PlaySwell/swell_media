module SwellMedia
	class UserEventsController < ApplicationController
		...
		def create
			...
			record_user_event( event: params[:event], guest_session: @guest_ession, user: current_user, on: @parent_obj, content: params[:content], opt_out_google_analytics: opt_out_google_analytics, rate: 1.second )
